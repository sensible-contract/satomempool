...
import "satomempool/utils"

func ExtractPkScriptForTxo(txid, Pkscript, scriptType []byte) (isNFT bool, codeHash, genesisId, addressPkh []byte, name, symbol string, value, decimal uint64) {
